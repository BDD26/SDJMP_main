    ...
    <div className="max-w-6xl mx-auto space-y-8 animate-fade-in pb-12">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <h1 className="text-5xl font-black tracking-tight font-heading">Data <span className="text-primary">Exports</span></h1>
          <p className="text-muted-foreground text-lg mt-3 max-w-xl">
            Export system data for external analysis, auditing, or backup. Generate custom CSV and PDF reports.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
           <Card className="border-none shadow-xl glass overflow-hidden bg-gradient-to-br from-primary/10 to-blue-500/10 border border-primary/20">
            <CardHeader>
