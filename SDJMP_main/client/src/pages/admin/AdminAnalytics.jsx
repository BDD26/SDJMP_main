  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 animate-fade-in pb-12">
      <div className="space-y-4">
        <Badge className="bg-primary/10 text-primary hover:bg-primary/20 transition-colors py-1 px-3 border-none capitalize font-bold">
          Platform Intelligence
        </Badge>
        <PageHeader
          title="Analytics & Insights"
          description="Real-time tracking of placement rates, skill demand gaps, and platform growth metrics."
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard icon={Target} title="Placement Rate" value="88.4%" trend="+12%" />
        <StatCard icon={Users} title="Total Students" value="2,450" trend="+4.2%" />
        <StatCard icon={Briefcase} title="Active Jobs" value="412" trend="-2.1%" trendUp={false} />
        <StatCard icon={Zap} title="Avg. Match Score" value="76%" trend="+5.4%" />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <GlassCard className="overflow-hidden bg-primary text-white">
          <CardHeader className="p-8">
